...
LEXICON_PRODUCT_SERVICE = {
    "Мастерская керамики": "Вы можете ознакомиться с услугами мастерской "
                           "керамики",
    "Виртуальная реальность": "Вы можете ознакомиться с услугами VR-клуба",
}


LEXICON_EVENT = {
    "event_menu": "Ниже перечислены предстоящие мероприятия",
    "Мастерская керамики": "Мастерская керамики ждет вас на мероприятих:",
    "Арт галерея": "pass:",
    "выбор года": "Тут вы можете означиться с событиями которые прошли в",
    "предстоящие мероприятия": "В ближайшее время у нас пройдут мероприятия:",
    "пустой список": "К сожалению предстоящих мероприятий не ожидаеться.",
}


CATEGORY_MENU_NAME_REVERSE_DICT = {
    "ceramic": "Мастерская керамики",
    "vr": "Виртуальная реальность",
    "art_galery": "Арт галерея",
    "events": "Мероприятия"
}

# LEXICON_PRODUCT_PRODUCT = {
#     "Арт галерея": "Здесь представлен список",
#     "Мастерская керамики": "Тут описание услыги виртуальной реальности, клавиатура-ссылки на посты вк",
#     "Виртуальная реальность": "Чтобы оставить заявку, выберите дату посещения",
# }
